...
- Upgraded to Unity 2018.3.6f1.
- Started optimizing sounds and soundfx a bit.
- Added new soundfx for powerups. Working on more.
- Added new game HUD with data located near top of screen based on suggestions by players.
- Added new explosion animations for ships, asteroids, and turrets.
- Added sparks animation when lasers hit each other.
- Added explosion animation for bonuses.
- Fixed some bugs with new animations having physics attached. 
  - Please report a bug if you see things moving in angles they shouldn't!
- Added new powerup animations. Need to fix some powerup sounds.
- Worked on making sound more uniform across all resolutions.
  - Needs work.

## Alpha 2.6.1 - 9/15/2018
