...
pricing_table:
  - name: Windows
    icon: <i class="fab fa-windows fa-3x text-white"></i>
    color: "#0078d7"
    features:
  ...
  - name: MacOS
    icon: <i class="fab fa-apple fa-3x text-white"></i>
    color: "#7d7d7d"
    features:
      - text: <strong>Version</strong><br />3.0.0-Alpha
        highlight: false
  ...
  - name: Linux
    icon: <i class="fab fa-linux fa-3x text-white"></i>
    color: "#282828"
    features:
      - text: <strong>Version</strong><br />3.0.0-Alpha
        highlight: false
  ...
  - name: Android
    icon: <i class="fab fa-android fa-3x text-white"></i>
    color: "#A4C639"
    features:
      - text: <strong>Version</strong><br />3.0.0-Alpha
        highlight: false
